(function (jQuery) {
  ...
  if (document.querySelectorAll("#service-chart-05").length) {
    const options = {
      series: [
        {
          name: "series1",
    ...
    const chart = new ApexCharts(
      document.querySelector("#service-chart-05"),
      options
    );
    chart.render();
    document.addEventListener("ColorChange", (e) => {
  ...
  if (document.querySelectorAll("#service-chart-06").length) {
    const options = {
      series: [
        {
          name: "series1",
    ...
    const chart = new ApexCharts(
      document.querySelector("#service-chart-06"),
      options
    );
    chart.render();
    document.addEventListener("ColorChange", (e) => {
  ...
  if (document.querySelectorAll("#service-chart-07").length) {
    const options = {
      series: [
        {
          name: "series1",
    ...
    const chart = new ApexCharts(
      document.querySelector("#service-chart-07"),
      options
    );
    chart.render();
    document.addEventListener("ColorChange", (e) => {
  ...
  if (document.querySelectorAll("#service-chart-08").length) {
    const options = {
      series: [
        {
          name: "series1",
    ...
    const chart = new ApexCharts(
      document.querySelector("#service-chart-08"),
      options
    );
    chart.render();
    document.addEventListener("ColorChange", (e) => {
  ...
  if (document.querySelectorAll("#service-chart-09").length) {
    const options = {
      series: [
        {
          name: "series1",
    ...
    const chart = new ApexCharts(
      document.querySelector("#service-chart-09"),
      options
    );
    chart.render();
    document.addEventListener("ColorChange", (e) => {
  ...
  if (document.querySelectorAll("#service-chart-10").length) {
    const options = {
      series: [
        {
          name: "series1",
    ...
    const chart = new ApexCharts(
      document.querySelector("#service-chart-10"),
      options
    );
    chart.render();
    document.addEventListener("ColorChange", (e) => {
