...
@section('title', 'Create CGT Grade')
@section('content')
    <div class="m-4 p-3">
        <div class="row">
            <div class="col-sm-12">
                <nav aria-label="breadcrumb" class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add CGT Grade</li>
                    </ol>
                </nav>
            </div>
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            ...
                            <h4 class="card-title">Add CGT Grade</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin:cgt_grades.store') }}" method="POST">
                            @csrf
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <label for="grade_name">Grade Name</label>
                                    <input class="form-control form-control-sm" id="grade_name" name="grade_name"
                                        type="text" value="{{ old('grade_name') }}" />
                                    @error('grade_name')
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <input class="form-control form-control-sm" id="billing_code" name="billing_code"
                                        type="text" value="{{ old('billing_code') }}" />
                                    @error('billing_code')
                                        <span class="invalid-feedback" style="display: block;" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
