            ...
            <div class="col-sm-12">
                <nav aria-label="breadcrumb" class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Color Summary</li>
                    </ol>
                </nav>
            </div>
            <div class="col-sm-12">
                <div class="card" style="height: 100vh">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Color Summary</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <form class="mb-5" id="filter" method="post" action="#">
                            ...
                            <div class="form-group row">
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control form-control-sm color_id select2" name="color_id">
                                ...
                                <div class="col-md-3">
                                    <label class="mb-2" for="NT">CGT Grade</label>
                                    <select class="form-control form-control-sm cgt_id select2" name="cgt_id">
                                        <option value=""> All </option>
                                        @if (isset($cgt_grades) & !empty($cgt_grades))
                                            @foreach ($cgt_grades as $key => $value)
                                                <option value="{{ $value->id }}">
                                                    {{ $value->grade_name ?? '' }}
                                                </option>
                                            @endforeach
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="flex-wrap d-flex justify-content-between align-items-center">
                                    <div class="header-title">
                                        <h4 class="card-title" id="color_total_val">{{ $total_scan_in_weight ?? '' }}</h4>
                                ...
                                <div class="flex-wrap d-flex align-items-center justify-content-between"
                                    ...
                                    <div class="d-grid gap col-md-6">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="ms-3">
                                                <span class="text-secondary" id="color_slug">Color</span>
                                                <li class="mt-1" id="color_slug_val">0</li>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-start">
                                            <svg class="mt-2" xmlns="http://www.w3.org/2000/svg" width="14"
                            ...
                            <div class="col-md-6">
                                <div class="table-responsive mt-4" style="overflow-y:auto; max-height:50vh">
                                    <table id="nt-colors" class="table table-bordered mb-0 colors_table" role="grid">
                                        <thead>
                                            <tr>
                                                <th>Color</th>
                                                <th>NT Grade</th>
...
@section('script')
    <script type="text/javascript">
        ...
        // any field change
        $('select[name=color_id],select[name=nt_id],select[name=cgt_id],select[name=year],select[name=warehouse_id],input[name=from_date],input[name=to_date]')
            .change(function() {
        ...
        function getColorSummary() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('admin:inventory.getNtByColorFilter') }}",
                data: {
                    _token: "{{ csrf_token() }}",
                ...
                success: function(response) {
                    ...
                    if (response.status === true) {
                        ...
                        $('#color_slug').html(data.color_slug);
                        $('#color_slug_val').html(data.total_weight_color_wise);
                        $('#color_total_val').html(data.total_weight_color_wise);
