            ...
            <div class="col-sm-12">
                <nav aria-label="breadcrumb" class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">CGT Summary</li>
                    </ol>
                </nav>
            </div>
            <div class="col-sm-12">
                <div class="card" style="height:100vh">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">CGT Summary</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="flex-wrap d-flex justify-content-between align-items-center">
                                    <div class="header-title">
                                        <h4 class="card-title" id="cgt_total_val">{{ $total_scan_in_weight ?? '' }}</h4>
                            ...
                            <div class="col-md-6">
                                <div class="table-responsive mt-4" style="overflow-y:auto; max-height:50vh">
                                    <table id="cgt-colors" class="table table mb-0 colors_table" role="grid">
                                        <thead>
                                            <tr>
                                                <th>CGT</th>
                                                <th>NT</th>
...
@section('script')
    <script type="text/javascript">
        ...
        function getCGTSummary() {

            $.ajax({
                type: 'POST',
                url: "{{ route('admin:inventory.getCgtSummaryByFilterr') }}",
                data: {
                    _token: "{{ csrf_token() }}",
                ...
                success: function(response) {
                    ...
                    if (response.status === true) {
                        ...
                        $('#cgt_total_val').html(data.total_weight_cgt_wise);
