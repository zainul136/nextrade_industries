            ...
            <div class="col-sm-12">
                <nav aria-label="breadcrumb" class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Cumulative CGT Summary</li>
                    </ol>
                </nav>
            </div>
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Cumulative CGT Summary</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        {{-- Filter --}}
                        <form class="mb-5" id="submit_comulative" method="post"
                            action="{{ route('admin:inventory.getComulativeCgtByFilter') }}">
                            @csrf
