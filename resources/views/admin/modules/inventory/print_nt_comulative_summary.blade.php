            ...
            <table id="cgt_comulative_summary" class="table table-bordered mb-0">
                <thead>
                    <tr>
                        ...
                        @foreach ($nt_grades as $key => $nt_grade)
                            <th>{{ $nt_grade->grade_name }}</th>
                        @endforeach
                ...
                <tbody class="text-dark">
                    @forelse ($nt_comulative as $key => $value)
                        ...
                        <tr>
                            ...
                            @php
                                $total_row_weight = 0;
                            @endphp
                            @isset($nt_comulative_weight[$key])
                                @foreach ($nt_comulative_weight[$key] as $key1 => $cgt)
                                    <td>{{ $cgt['nt_weight'] }}</td>
                                @endforeach
                            @else
                                <td>{{ 0 }}</td>
